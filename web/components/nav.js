        ...
        return (React.createElement("div", {className: "nav"}, 
            React.createElement("ul", null, 
                React.createElement("li", null, 
                    React.createElement(react_router_1.IndexLink, {to: "/", className: "nav_a", activeClassName: "on"}, "首  页")
                ), 
                React.createElement("li", null, 
                    React.createElement("a", {href: "#", className: "nav_a"}, "党委工作")
                ), 
                React.createElement("li", null, 
                    React.createElement("a", {href: "#", className: "nav_a"}, "党组织")
                ), 
                React.createElement("li", null, 
                    React.createElement(react_router_1.Link, {to: "/party-member", className: "nav_a", activeClassName: "on"}, "党员发展")
                ), 
                React.createElement("li", null, 
