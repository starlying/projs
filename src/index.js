...
const partyMemberPage_1 = require('./member/partyMemberPage');
const partyMemberAddPage_1 = require('./member/add/partyMemberAddPage');
const notFoundPage_1 = require('./components/notFoundPage');
const loginPage_1 = require('./containers/loginPage');
utils.Page.xDomain();
...
react_dom_1.render(React.createElement(react_redux_1.Provider, {store: store}, 
    React.createElement(react_router_1.Router, {history: react_router_1.browserHistory}, 
        ...
        React.createElement(react_router_1.Route, {path: "/", component: app_1.default}, 
            ...
            React.createElement(react_router_1.Route, {path: "/member", component: partyMemberPage_1.default}), 
            React.createElement(react_router_1.Route, {path: "/member/add", component: partyMemberAddPage_1.default}), 
